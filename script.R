#  Data from http://www.cens.uni-bonn.de/experiments/falk-szech
# This is the data from the paper at http://www.sciencemag.org/content/340/6133/707.full.pdf
...
## Fig 1
#######################
# Fig1.dta$option_b = as.factor(Fig1.dta$option_b)
# Fig1.dta$treatment = as.factor(Fig1.dta$treatment)

p = ggplot(Fig1.dta, aes(x = treatment, fill = option_b, ))
p = p + geom_bar(position = "fill")
# p = p + geom_errorbar() # see for details: http://docs.ggplot2.org/0.9.3.1/geom_errorbar.html
